...
import io.fusionsphere.reflect.ReflectionUtil;
import io.fusionsphere.spring.boot.datasource.properties.DynamicDataSourceProperties;
import io.fusionsphere.spring.boot.datasource.properties.ExtensionDataSourceProperties;
...
public class DynamicRoutingDataSource extends AbstractRoutingDataSource implements DisposableBean {
    ...
    protected Object determineCurrentLookupKey() {
        ...
        log.info("currentDataSource:{}, defaultDataSource:{}", currentDataSource, properties.getPrimary());
