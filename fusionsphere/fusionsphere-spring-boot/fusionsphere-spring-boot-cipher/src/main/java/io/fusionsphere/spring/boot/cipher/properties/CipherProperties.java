package io.fusionsphere.spring.boot.cipher.properties;

import io.fusionsphere.spring.boot.cipher.core.encryptor.AlgorithmTypeEnum;
 ...
 */
@Data
@ConfigurationProperties(prefix = CipherProperties.PREFIX)
public class CipherProperties {

    public static final String PREFIX = "fusionsphere.cipher";
