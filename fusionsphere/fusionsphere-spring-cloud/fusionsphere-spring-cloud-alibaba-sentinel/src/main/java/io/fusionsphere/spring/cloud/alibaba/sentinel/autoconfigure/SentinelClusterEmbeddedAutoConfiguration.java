package io.fusionsphere.spring.cloud.alibaba.sentinel.autoconfigure;
...
import io.fusionsphere.spring.cloud.alibaba.sentinel.properties.ClusterAppAssignMap;
import io.fusionsphere.spring.cloud.alibaba.sentinel.properties.SentinelClusterEmbeddedProperties;
...
@ConditionalOnProperty(prefix = SentinelClusterEmbeddedProperties.PREFIX, name = "enabled", havingValue = "true")
