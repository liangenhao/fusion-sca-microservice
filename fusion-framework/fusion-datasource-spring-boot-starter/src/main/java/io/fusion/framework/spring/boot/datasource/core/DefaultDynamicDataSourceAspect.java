...
import io.fusion.framework.spring.boot.datasource.annotation.TargetDataSource;
...
public class DefaultDynamicDataSourceAspect implements DynamicDataSourceAspect {
    ...
    @Pointcut("@annotation(io.fusion.framework.spring.boot.datasource.annotation.TargetDataSource) " +
            "|| @within(io.fusion.framework.spring.boot.datasource.annotation.TargetDataSource)")
